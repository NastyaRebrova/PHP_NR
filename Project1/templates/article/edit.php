...
<div class="container mt-4">
    ...
    <form action="/PHP_NR/Project1/www/article/<?= $article->getId() ?>/update" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="text" name="text" rows="5"><?= htmlspecialchars($article->getText()) ?></textarea>
        </div>
